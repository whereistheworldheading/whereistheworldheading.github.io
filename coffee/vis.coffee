...
texts = [
  {key:"refugee",file:"refugee.csv",name:"Refugee"}
  {key:"war",file:"war.csv",name:"War"}
  {key:"threat",file:"threat.csv",name:"Threat"}
  {key:"military",file:"military.csv",name:"Military"}
  {key:"cyber",file:"cyber.csv",name:"Cyber"}
  {key:"conflict",file:"conflict.csv",name:"Conflict"}
  {key:"arms",file:"arms.csv",name:"Arms"}
  {key:"civil",file:"civil.csv",name:"Civil"}
]
